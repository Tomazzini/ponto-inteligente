...
import com.tomaz.ponto.inteligente.api.dto.FuncionarioDto;
...
public class FuncionarioController {
	...
	private static final org.slf4j.Logger log = LoggerFactory.getLogger(FuncionarioController.class);
	...
	private void atualizarDadosFuncionario(Funcionario funcionario, FuncionarioDto funcionarioDto, BindingResult result)
		...
		funcionarioDto.getDtdHorasTrabalhoDia()
				.ifPresent(qtdHorasTrabDia -> funcionario.setQtdHorasTrabalhadas(Float.valueOf(qtdHorasTrabDia)));
	...
	private FuncionarioDto converterFuncionarioDto(Funcionario funcionario) {
		...
		funcionario.getQtdHorasTrabalhadas().ifPresent(
				qtdHorasTrabDia -> funcionarioDto.setDtdHorasTrabalhoDia(Optional.of(Float.toString(qtdHorasTrabDia))));
